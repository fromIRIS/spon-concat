        ...
        function getHtmlContent (htmlContent) {
            ...
            if (htmlContent.search(/<script/i) == -1) {
                ...
                if (htmlContent.search(/<script(.+)?src/i) < htmlContent.indexOf('<body>')) {
                    htmlContent = htmlContent.substring(0, htmlContent.indexOf('<body>')).replace(/<script/gi, '') + htmlContent.substring(htmlContent.indexOf('<body>'));
                    return getHtmlContent(htmlContent);


                }else if (htmlContent.search(/<script(.+)?src/i) < htmlContent.indexOf('</body>')) {
